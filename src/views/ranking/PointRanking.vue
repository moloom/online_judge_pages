<template>
  <div>
    <div style="margin-left: 70px;height: 30px;margin-top: 30px;font-size: 20px;">富豪榜</div>
    <table class="table">
      <tr class="th">
        <td style="width: 10%;">#</td>
        <td style="width: 25%;">昵称</td>
        <td style="width: 55%;">签名</td>
        <td style="width: 10%;">M币</td>
      </tr>
      ...
      <tr v-for="(l,index) in list" :key="l.id">
        ...
        <td>
          <el-link style="color: #3a8ee6;">{{l.name}}</el-link>
        </td>
        <td>{{ l.signature }}</td>
        <td>{{ l.point }}</td>
      </tr>
