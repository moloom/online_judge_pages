<template>
  <div class="d1">
    ...
    <div class="problemExtractInfo fontSize">
      ...
      <div class="problemExtractD1">
        <!-- 点赞图标：未点赞状态 -->
        <svg class="icon" viewBox="0 0 1024 1024" width="16" height="16" style="margin-top: 2px;" v-show="!isGood"
             @click="updateGoodAndBad(1)">
          <path
      ...
      <div class="problemExtractD1">
        <!-- 点踩图标：未点踩状态 -->
        <svg class="icon" viewBox="0 0 1024 1024" width="14" height="14" style="margin-top: 3px;" v-show="!isBad"
             @click="updateGoodAndBad(-1)">
          <path
